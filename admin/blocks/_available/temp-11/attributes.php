...
return [
	...
	'titleTypo'      => [
		'type'    => 'string',
		'default' => '{"fontfamily":"Work Sans","variants":["100","200","300","regular","500","600","700","800","900"],"desktop":{"fontweight":"900","fontsize":42,"lineheight":120,"letterspacing":1},"mobile":{"fontweight":"700","fontsize":34,"lineheight":120,"letterspacing":1}}',
	],
	'bodyTypo'      => [
		'type'    => 'string',
	...
	'background'    => [
		...
		'default' => json_encode( [
			                          ...
			                          'image'   => [
				                          'id' => '',
				                          'full' => Plugin::get_cdn_url('temp-11--bg.jpg'),
				                          'thumb' => '',
			                          ],
			                          'gallery' => [],
			                          'video'   => [],
