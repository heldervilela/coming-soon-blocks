...
import ImageUpload from '../../components/control/ImageUpload.js';
...
class Edit extends Component {
	...
	constructor( { attributes } ) {
		...
		this.state = {
			...
			contentImage: JSON.parse( this.props.attributes.contentImage ),
				...
				<main data-block={name} className={className}>
					...
					<div className="the-wrapper">
						...
						<div className="the-content">
							<div className="intro-text -body__typography" style={{ maxWidth: `${contentMaxWidth}px` }}>
								{
									addLogo && (
						...
						<div className="the-image">
							<ImageUpload
								onSelect={( media ) => {
									...
									this.setState( ( prevState ) => ({ ...prevState, contentImage: image }) );
									setAttributes( { contentImage: JSON.stringify( image ) } );
								}}
								imageAttrs={this.state.contentImage}
								allowedMediaTypes={ALLOWED_MEDIA_TYPES}
							/>
						</div>
